...
void    plBaseSoundEmitterComponent::IGrabFadeValues(plSound* sound)
{
    if (fCompPB->GetInt((ParamID)kSndFadeInEnable, 0) != 0) {
        ...
        case kSndFadeTypeLinear:
            type = plSound::plFadeParams::kLinear;
            break;

        case kSndFadeTypeLogarithmic:
            type = plSound::plFadeParams::kLogarithmic;
            break;

        case kSndFadeTypeExponential:
            type = plSound::plFadeParams::kExponential;
            break;
        }
...
public:
    ...
    virtual bool    IsLocalOnly(void) const {
        if (fCompPB->GetInt((ParamID)kSndIsLocalOnly)) {
            return true;
        } else {
            return false;
        }
...
protected:
    ...
    virtual bool    IAllowStereoFiles(void) const {
        return false;
    }
...
//
    ...
    protected:
        ...
        virtual bool    IHasWaveformProps(void) const {
            return false;
        }
    };
