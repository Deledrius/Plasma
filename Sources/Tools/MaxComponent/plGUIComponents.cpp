...
public:
    ...
    int     GetHandledDlgItem(void) const {
        return fDlgItem;
    }
...
bool plGUIDialogComponent::Convert(plMaxNode* node, plErrorMsg* pErrMsg)
{
    ...
    } else if (obj->CanConvertToType(Class_ID(SIMPLE_CAM_CLASS_ID, 0))) {
...
protected:
    ...
    virtual pfGUIControlMod* IGetNewControl(void) {
        return new pfGUIButtonMod;
    }
    virtual bool            ICanHaveProxy(void) {
        return true;
    }
...
protected:
    ...
    virtual pfGUIControlMod* IGetNewControl(void) {
        return new pfGUIListBoxMod;
    }
    virtual bool            INeedsDynamicText(void) {
        return true;
    }
...
protected:
    ...
    virtual pfGUIControlMod* IGetNewControl(void) {
        return new pfGUIRadioGroupCtrl;
    }
...
protected:
    ...
    virtual pfGUIControlMod* IGetNewControl(void) {
        return new pfGUIDynDisplayCtrl;
    }
    virtual bool            IHasProcRollout(void) {
        return false;
    }
...
protected:
    ...
    virtual pfGUIControlMod* IGetNewControl(void) {
        return new pfGUIMultiLineEditCtrl;
    }
    virtual bool            INeedsDynamicText(void) {
        return true;
    }
...
//      hsAssert( menu != nil, "Somehow got a bad poitner in GUIMenu::Convert()" );
        ...
        case 0:
            menu->SetAlignment(pfGUIPopUpMenu::kAlignUpLeft);
            break;

        case 1:
            menu->SetAlignment(pfGUIPopUpMenu::kAlignUpRight);
            break;

        case 2:
            menu->SetAlignment(pfGUIPopUpMenu::kAlignDownLeft);
            break;

        case 3:
            menu->SetAlignment(pfGUIPopUpMenu::kAlignDownRight);
            break;
        }
    }
