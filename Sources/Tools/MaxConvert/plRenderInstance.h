...
public:
    ...
    void SetNext(plRenderInstance* n) {
        fNext = n;
    }
    void Cleanup();

    virtual RenderInstance* Next() {
        return fNext;    // next in list
    }
    ...
    virtual int NumLights() {
        return fLights.GetCount();
    }
    virtual LightDesc* Light(int n) {
        return fLights[n];
    }
    virtual void AddLight(LightDesc* l) {
        fLights.Append(l);
    }
    ...
    virtual INode* GetINode() {
        return fNode;    // get INode for instance
    }
    virtual Object* GetEvalObject() {
        return fObject;    // evaluated object for instance
    }
