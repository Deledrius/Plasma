...
public:
    ...
    void*           Create(BOOL loading) {
        return new plBumpMtl(loading);
    }
    const TCHAR*    ClassName()     {
        return GetString(IDS_BUMP_MTL);
    }
    SClass_ID       SuperClassID()  {
        return MATERIAL_CLASS_ID;
    }
    Class_ID        ClassID()       {
        return BUMP_MTL_CLASS_ID;
    }
...
ClassDesc2* GetBumpMtlDesc()
{
    return &plBumpMtlDesc;
}
...
Color plBumpMtl::GetAmbient(int mtlNum, BOOL backFace)
{
    return Color(0, 0, 0);
}
Color plBumpMtl::GetDiffuse(int mtlNum, BOOL backFace)
{
    return Color(0, 0, 0);
}
Color plBumpMtl::GetSpecular(int mtlNum, BOOL backFace)
{
    return Color(0, 0, 0);
}
...
float plBumpMtl::GetShininess(int mtlNum, BOOL backFace)
{
    return 0.0f;
}
float plBumpMtl::GetShinStr(int mtlNum, BOOL backFace)
{
    return 0.0f;
}
float plBumpMtl::WireSize(int mtlNum, BOOL backFace)
{
    return 0.0f;
}
...
// Advanced Block
int     plBumpMtl::GetBasicWire()
{
    return 0;
}
int     plBumpMtl::GetMeshOutlines()
{
    return 0;
}
int     plBumpMtl::GetTwoSided()
{
    return 0;
}
int     plBumpMtl::GetSoftShadow()
{
    return 0;
}
int     plBumpMtl::GetNoProj()
{
    return 0;
}
int     plBumpMtl::GetVertexShade()
{
    return 0;
}
int     plBumpMtl::GetNoShade()
{
    return 0;
}
int     plBumpMtl::GetNoFog()
{
    return 0;
}
int     plBumpMtl::GetWhite()
{
    return 0;
}
int     plBumpMtl::GetZOnly()
{
    return 0;
}
...
int     plBumpMtl::GetZNoRead()
{
    return 0;
}
int     plBumpMtl::GetZNoWrite()
{
    return 0;
}
int     plBumpMtl::GetZInc()
{
    return 0;
}
int     plBumpMtl::GetAlphaTestHigh()
{
    return 0;
}

// Animation block
const char*  plBumpMtl::GetAnimName()
{
    return fAnimPB->GetStr(kPBAnimName);
}
int          plBumpMtl::GetAutoStart()
{
...
const char*  plBumpMtl::GetAnimLoopName()
{
    return fAnimPB->GetStr(kPBAnimLoopName);
}

// Basic block
int     plBumpMtl::GetColorLock()
{
    return 0;
}
Color   plBumpMtl::GetAmbColor()
{
    return Color(0, 0, 0);
}
Color   plBumpMtl::GetColor()
{
    return Color(0, 0, 0);
}
int     plBumpMtl::GetOpacity()
{
    return 100;
}
int     plBumpMtl::GetEmissive()
{
    return 0;
}
int     plBumpMtl::GetUseSpec()
{
    return 0;
}
int     plBumpMtl::GetShine()
{
    return 0;
}
Color   plBumpMtl::GetSpecularColor()
{
    return Color(0, 0, 0);
}
int     plBumpMtl::GetDiffuseColorLock()
{
    return 0;
}
Color   plBumpMtl::GetRuntimeColor()
{
    return fBasicPB->GetColor(kBumpBasRunColor);
}
Control* plBumpMtl::GetPreshadeColorController()
{
    return nil;
}
Control* plBumpMtl::GetAmbColorController()
{
    return nil;
}
Control* plBumpMtl::GetOpacityController()
{
    return nil;
}
Control* plBumpMtl::GetSpecularColorController()
{
    return nil;
}
Control* plBumpMtl::GetRuntimeColorController()
{
    return GetParamBlock2Controller(fBasicPB, ParamID(kBumpBasRunColor));
}

// Layer block
Texmap* plBumpMtl::GetBaseLayer()
{
    return fBasicPB->GetTexmap(kBumpBasLayer);
}
int     plBumpMtl::GetTopLayerOn()
{
    return 0;
}
Texmap* plBumpMtl::GetTopLayer()
{
    return nil;
}
int     plBumpMtl::GetLayerBlend()
{
    return 0;
}
int     plBumpMtl::GetOutputAlpha()
{
    return 0;
}
int     plBumpMtl::GetOutputBlend()
{
    return fBasicPB->GetInt(kBumpBasSpecular) ? plPassMtlBase::kBlendAdd : plPassMtlBase::kBlendAlpha;
}
