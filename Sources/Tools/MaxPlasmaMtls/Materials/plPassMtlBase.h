...
public:
    ...
    virtual int          GetEaseInType() {
        return plAnimEaseTypes::kNoEase;
    }
...
public:
    plEaseAccessor(int blockID, int easeInMinID, int easeInMaxID, int easeInNormID,
        ...
        fDoingUpdate = false;
        fBlockID = blockID;
        fEaseInMinID = easeInMinID;
        fEaseInMaxID = easeInMaxID;
        fEaseInNormID = easeInNormID;
        fEaseOutMinID = easeOutMinID;
        fEaseOutMaxID = easeOutMaxID;
        fEaseOutNormID = easeOutNormID;
    }
