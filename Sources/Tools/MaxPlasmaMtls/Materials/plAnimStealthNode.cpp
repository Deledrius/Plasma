...
public:
    ...
    void*           Create(BOOL loading) {
        return new plAnimStealthNode(loading);
    }
    const TCHAR*    ClassName()     {
        return GetString(IDS_STEALTH_NAME);
    }
    SClass_ID       SuperClassID()  {
        return HELPER_CLASS_ID;
    }
    Class_ID        ClassID()       {
        return ANIMSTEALTH_CLASSID;
    }
    const TCHAR*    Category()      {
        return NULL;
    }
    const TCHAR*    InternalName()  {
        return _T("PlasmaAnimStealthInfo");
    }
    HINSTANCE       HInstance()     {
        return hInstance;
    }
...
ClassDesc2* GetStealthClassDesc()
{
    return &sStealthClassDesc;
}
...
bool    plAnimStealthNode::GetAutoStart(void) const
{
    return (bool)fParamBlock->GetInt((ParamID)kPBAutoStart);
}
void    plAnimStealthNode::SetAutoStart(bool b)
{
    fParamBlock->SetValue((ParamID)kPBAutoStart, 0, (int)b);
};

bool        plAnimStealthNode::GetLoop(void) const
{
    return fParamBlock->GetInt((ParamID)kPBLoop);
}
plString    plAnimStealthNode::GetLoopName(void) const
{
    return plString::FromUtf8(fParamBlock->GetStr((ParamID)kPBLoopName));
}
...
uint8_t       plAnimStealthNode::GetEaseInType(void) const
{
    return (uint8_t)fParamBlock->GetInt((ParamID)kPBEaseInType);
}
float    plAnimStealthNode::GetEaseInLength(void) const
{
    return (float)fParamBlock->GetFloat((ParamID)kPBEaseInLength);
}
float    plAnimStealthNode::GetEaseInMin(void) const
{
    return (float)fParamBlock->GetFloat((ParamID)kPBEaseInMin);
}
float    plAnimStealthNode::GetEaseInMax(void) const
{
    return (float)fParamBlock->GetFloat((ParamID)kPBEaseInMax);
}
...
uint8_t       plAnimStealthNode::GetEaseOutType(void) const
{
    return (uint8_t)fParamBlock->GetInt((ParamID)kPBEaseOutType);
}
float    plAnimStealthNode::GetEaseOutLength(void) const
{
    return (float)fParamBlock->GetFloat((ParamID)kPBEaseOutLength);
}
float    plAnimStealthNode::GetEaseOutMin(void) const
{
    return (float)fParamBlock->GetFloat((ParamID)kPBEaseOutMin);
}
float    plAnimStealthNode::GetEaseOutMax(void) const
{
    return (float)fParamBlock->GetFloat((ParamID)kPBEaseOutMax);
}
