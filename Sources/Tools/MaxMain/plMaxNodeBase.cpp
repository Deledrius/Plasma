...
plKey           plMaxNodeBase::GetKey()
{
    GetMD;
    return (pMD) ? pMD->GetKey() : nil;
}
plSceneObject*  plMaxNodeBase::GetSceneObject()
{
    GetMD;
    return (pMD) ? pMD->GetSceneObject() : nil;
}
bool            plMaxNodeBase::GetForceLocal()
{
    GetMD;
    return (pMD) ? pMD->GetForceLocal() : false;
}
bool            plMaxNodeBase::GetReverseSort()
{
    GetMD;
    return (pMD) ? pMD->GetReverseSort() : false;
}
bool            plMaxNodeBase::GetSortAsOpaque()
{
    GetMD;
    return (pMD) ? pMD->GetSortAsOpaque() : false;
}
bool            plMaxNodeBase::GetVS()
{
    GetMD;
    return (pMD) ? pMD->GetVS() : false;
}
bool            plMaxNodeBase::GetHasWaterHeight()
{
    GetMD;
    return (pMD) ? pMD->GetHasWaterHeight() : false;
}
float           plMaxNodeBase::GetWaterHeight()
{
    GetMD;
    return (pMD) ? pMD->GetWaterHeight() : 0;
}
bool            plMaxNodeBase::GetSmoothAll()
{
    GetMD;
    return (pMD) ? pMD->GetSmoothAll() : false;
}
bool            plMaxNodeBase::GetForceSortable()
{
    GetMD;
    return (pMD) ? pMD->GetForceSortable() : false;
}
bool            plMaxNodeBase::GetConcave()
{
    GetMD;
    return (pMD) ? pMD->GetConcave() : false;
}
bool            plMaxNodeBase::GetCalcEdgeLens()
{
    GetMD;
    return (pMD) ? pMD->GetCalcEdgeLens() : false;
}
bool            plMaxNodeBase::GetRunTimeLight()
{
    GetMD;
    return (pMD) ? pMD->GetRunTimeLight() : false;
}
bool            plMaxNodeBase::GetForceMatShade()
{
    GetMD;
    return (pMD) ? pMD->GetForceMatShade() : false;
}
bool            plMaxNodeBase::GetForceVisLOS()
{
    GetMD;
    return (pMD) ? pMD->GetForceVisLOS() : false;
}
bool            plMaxNodeBase::GetEnviron()
{
    GetMD;
    return (pMD) ? pMD->GetEnviron() : false;
}
bool            plMaxNodeBase::GetEnvironOnly()
{
    GetMD;
    return (pMD) ? pMD->GetEnvironOnly() : false;
}
bool            plMaxNodeBase::GetWaterDecEnv()
{
    GetMD;
    return (pMD) ? pMD->GetWaterDecEnv() : false;
}
bool            plMaxNodeBase::GetNoPreShade()
{
    GetMD;
    return (pMD) ? pMD->GetNoPreShade() && !pMD->GetForcePreShade() : false;
}
bool            plMaxNodeBase::GetForcePreShade()
{
    GetMD;
    return (pMD) ? pMD->GetForcePreShade() : false;
}
plKey           plMaxNodeBase::GetRoomKey()
{
    GetMD;
    return (pMD) ? pMD->GetRoomKey() : nil;
}
bool            plMaxNodeBase::GetDrawable()
{
    GetMD;
    return (pMD) ? pMD->GetDrawable() : false;
}
bool            plMaxNodeBase::GetPhysical()
{
    GetMD;
    return (pMD) ? pMD->GetPhysical() : false;
}
bool            plMaxNodeBase::GetItinerant()
{
    GetMD;
    return (pMD) ? pMD->GetItinerant() : false;
}
bool            plMaxNodeBase::GetUnBounded()
{
    GetMD;
    return (pMD) ? pMD->GetUnBounded() : false;
}
bool            plMaxNodeBase::GetDisableNormal()
{
    GetMD;
    return (pMD) ? pMD->GetDisableNormal() : false;
}
uint32_t        plMaxNodeBase::GetDecalLevel()
{
    GetMD;
    return (pMD) ? pMD->GetDecalLevel() : 0;
}
bool            plMaxNodeBase::GetMovable()
{
    GetMD;
    return (pMD) ? pMD->GetMovable() : false;
}
bool            plMaxNodeBase::GetIsBarney()
{
    GetMD;
    return (pMD) ? pMD->GetIsBarney() : false;
}
bool            plMaxNodeBase::GetForceShadow()
{
    GetMD;
    return (pMD) ? pMD->GetForceShadow() : false;
}
bool            plMaxNodeBase::GetAlphaTestHigh()
{
    GetMD;
    return (pMD) ? pMD->GetAlphaTestHigh() : false;
}
bool            plMaxNodeBase::GetFilterInherit()
{
    GetMD;
    return (pMD) ? pMD->GetFilterInherit() : false;
}
bool            plMaxNodeBase::GetNoShadow()
{
    GetMD;
    return (pMD) ? pMD->GetNoShadow() : false;
}
bool            plMaxNodeBase::GetNoSpanSort()
{
    GetMD;
    return (pMD) ? pMD->GetNoSpanSort() : false;
}
bool            plMaxNodeBase::GetNoSpanReSort()
{
    GetMD;
    return (pMD) ? pMD->GetNoSpanReSort() : false;
}
bool            plMaxNodeBase::GetNoFaceSort()
{
    GetMD;
    return (pMD) ? pMD->GetNoFaceSort() : false;
}
bool            plMaxNodeBase::GetNoDeferDraw()
{
    GetMD;
    return (pMD) ? pMD->GetNoDeferDraw() : false;
}
bool            plMaxNodeBase::GetBlendToFB()
{
    GetMD;
    return (pMD) ? pMD->GetBlendToFB() : false;
}
bool            plMaxNodeBase::GetForceMaterialCopy()
{
    GetMD;
    return (pMD) ? pMD->GetForceMaterialCopy() : false;
}
bool            plMaxNodeBase::GetInstanced()
{
    GetMD;
    return (pMD) ? pMD->GetInstanced() : false;
}
bool            plMaxNodeBase::GetParticleRelated()
{
    GetMD;
    return (pMD) ? pMD->GetParticleRelated() : false;
}
uint32_t        plMaxNodeBase::GetSoundIdxCounter()
{
    GetMD;
    return (pMD) ? pMD->GetSoundIdxCounter() : 0;
}
plSceneObject*  plMaxNodeBase::GetAvatarSO()
{
    GetMD;
    return (pMD) ? pMD->GetAvatarSO() : nil;
}
BOOL            plMaxNodeBase::HasFade()
{
    GetMD;
    return (pMD) ? pMD->HasFade() : false;
}
Box3            plMaxNodeBase::GetFade()
{
    GetMD;
    return (pMD) ? pMD->GetFade() : Box3(Point3(0, 0, 0), Point3(0, 0, 0));
}
bool            plMaxNodeBase::GetDup2Sided()
{
    GetMD;
    return (pMD) ? pMD->GetDup2Sided() : false;
}
bool            plMaxNodeBase::GetRadiateNorms()
{
    GetMD;
    return (pMD) ? pMD->GetRadiateNorms() : false;
}
BOOL            plMaxNodeBase::HasNormalChan()
{
    GetMD;
    return (pMD) ? pMD->HasNormalChan() : false;
}
int             plMaxNodeBase::GetNormalChan()
{
    GetMD;
    return (pMD) ? pMD->GetNormalChan() : 0;
}
bool            plMaxNodeBase::GetIsGUI()
{
    GetMD;
    return (pMD) ? pMD->GetIsGUI() : false;
}
plSharedMesh*   plMaxNodeBase::GetSwappableGeom()
{
    GetMD;
    return (pMD) ? pMD->GetSwappableGeom() : nil;
}
uint32_t        plMaxNodeBase::GetSwappableGeomTarget()
{
    GetMD;
    return (pMD) ? pMD->GetSwappableGeomTarget() : -1;
}
plMaxBoneMap*   plMaxNodeBase::GetBoneMap()
{
    GetMD;
    return (pMD) ? pMD->GetBoneMap() : nil;
}
bool            plMaxNodeBase::GetOverrideHighLevelSDL()
{
    GetMD;
    return (pMD) ? pMD->GetOverrideHighLevelSDL() : false;
}
uint8_t         plMaxNodeBase::GetAnimCompress()
{
    GetMD;
    return (pMD) ? pMD->GetAnimCompress() : false;
}
float           plMaxNodeBase::GetKeyReduceThreshold()
{
    GetMD;
    return (pMD) ? pMD->GetKeyReduceThreshold() : 0;
}
int             plMaxNodeBase::NumRenderDependencies()
{
    GetMD;
    return (pMD) ? pMD->NumRenderDependencies() : 0;
}
plMaxNodeBase*  plMaxNodeBase::GetRenderDependency(int i)
{
    GetMD;
    return (pMD) ? pMD->GetRenderDependency(i) : nil;
}

int             plMaxNodeBase::NumBones()
{
    GetMD;
    return (pMD) ? pMD->NumBones() : 0;
}
plMaxNodeBase*  plMaxNodeBase::GetBone(int i)
{
    GetMD;
    return (pMD) ? pMD->GetBone(i) : nil;
}
...
//------------------------------
void            plMaxNodeBase::SetCanConvert(bool b)
{
    GetMD;
    pMD->SetCanConvert(b);
}
void            plMaxNodeBase::SetMesh(hsGMesh* p)
{
    GetMD;
    pMD->SetMesh(p);
}
void            plMaxNodeBase::SetRoomKey(plKey p)
{
    GetMD;
    pMD->SetRoomKey(p);
}
void            plMaxNodeBase::SetDrawable(bool b)
{
    GetMD;
    pMD->SetDrawable(b);
}
void            plMaxNodeBase::SetPhysical(bool b)
{
    GetMD;
    pMD->SetPhysical(b);
}
//void          plMaxNodeBase::SetItinerant(bool b);
void            plMaxNodeBase::SetUnBounded(bool b)
{
    GetMD;
    pMD->SetUnBounded(b);
}
void            plMaxNodeBase::SetDisableNormal(bool b)
{
    GetMD;
    pMD->SetDisableNormal(b);
}
void            plMaxNodeBase::SetDecalLevel(uint32_t i)
{
    GetMD;
    pMD->SetDecalLevel(i);
}
void            plMaxNodeBase::SetMovable(bool b)
{
    GetMD;
    pMD->SetMovable(b);
    pMD->SetRunTimeLight(b);
    pMD->SetNoPreShade(b);
}
void            plMaxNodeBase::SetReverseSort(bool b)
{
    GetMD;
    pMD->SetReverseSort(b);
}
void            plMaxNodeBase::SetSortAsOpaque(bool b)
{
    GetMD;
    pMD->SetSortAsOpaque(b);
}
void            plMaxNodeBase::SetVS(bool b)
{
    GetMD;
    pMD->SetVS(b);
}
void            plMaxNodeBase::SetHasWaterHeight(bool b)
{
    GetMD;
    pMD->SetHasWaterHeight(b);
}
void            plMaxNodeBase::SetWaterHeight(float h)
{
    GetMD;
    pMD->SetWaterHeight(h);
}
void            plMaxNodeBase::SetSmoothAll(bool b)
{
    GetMD;
    pMD->SetSmoothAll(b);
}
void            plMaxNodeBase::SetForceSortable(bool b)
{
    GetMD;
    pMD->SetForceSortable(b);
}
void            plMaxNodeBase::SetConcave(bool b)
{
    GetMD;
    pMD->SetConcave(b);
}
void            plMaxNodeBase::SetCalcEdgeLens(bool b)
{
    GetMD;
    pMD->SetCalcEdgeLens(b);
}
void            plMaxNodeBase::SetRunTimeLight(bool b)
{
    GetMD;
    pMD->SetRunTimeLight(b);
}
void            plMaxNodeBase::SetForceMatShade(bool b)
{
    GetMD;
    pMD->SetForceMatShade(b);
}
void            plMaxNodeBase::SetForceVisLOS(bool b)
{
    GetMD;
    pMD->SetForceVisLOS(b);
}
void            plMaxNodeBase::SetEnviron(bool b)
{
    GetMD;
    pMD->SetEnviron(b);
}
void            plMaxNodeBase::SetEnvironOnly(bool b)
{
    GetMD;
    pMD->SetEnvironOnly(b);
}
void            plMaxNodeBase::SetWaterDecEnv(bool b)
{
    GetMD;
    pMD->SetWaterDecEnv(b);
}
void            plMaxNodeBase::SetNoPreShade(bool b)
{
    GetMD;
    pMD->SetNoPreShade(b);
}
void            plMaxNodeBase::SetForcePreShade(bool b)
{
    GetMD;
    pMD->SetForcePreShade(b);
}
void            plMaxNodeBase::SetForceLocal(bool b)
{
    GetMD;
    pMD->SetForceLocal(b);
}
void            plMaxNodeBase::SetIsBarney(bool b)
{
    GetMD;
    pMD->SetIsBarney(b);
}
void            plMaxNodeBase::SetForceShadow(bool b)
{
    GetMD;
    pMD->SetForceShadow(b);
}
void            plMaxNodeBase::SetAlphaTestHigh(bool b)
{
    GetMD;
    pMD->SetAlphaTestHigh(b);
}
void            plMaxNodeBase::SetFilterInherit(bool b)
{
    GetMD;
    pMD->SetFilterInherit(b);
}
void            plMaxNodeBase::SetNoShadow(bool b)
{
    GetMD;
    pMD->SetNoShadow(b);
}
void            plMaxNodeBase::SetNoSpanSort(bool b)
{
    GetMD;
    pMD->SetNoSpanSort(b);
}
void            plMaxNodeBase::SetNoSpanReSort(bool b)
{
    GetMD;
    pMD->SetNoSpanReSort(b);
}
void            plMaxNodeBase::SetNoFaceSort(bool b)
{
    GetMD;
    pMD->SetNoFaceSort(b);
}
void            plMaxNodeBase::SetNoDeferDraw(bool b)
{
    GetMD;
    pMD->SetNoDeferDraw(b);
}
void            plMaxNodeBase::SetBlendToFB(bool b)
{
    GetMD;
    pMD->SetBlendToFB(b);
}
void            plMaxNodeBase::SetForceMaterialCopy(bool b)
{
    GetMD;
    pMD->SetForceMaterialCopy(b);
}
void            plMaxNodeBase::SetInstanced(bool b)
{
    GetMD;
    pMD->SetInstanced(b);
}
void            plMaxNodeBase::SetParticleRelated(bool b)
{
    GetMD;
    pMD->SetParticleRelated(b);
}
void            plMaxNodeBase::SetSoundIdxCounter(uint32_t ctr)
{
    GetMD;
    pMD->SetSoundIdxCounter(ctr);
}
void            plMaxNodeBase::SetAvatarSO(plSceneObject* so)
{
    GetMD;
    pMD->SetAvatarSO(so);
}
void            plMaxNodeBase::SetFade(const Box3& b)
{
    GetMD;
    pMD->SetFade(b);
}
void            plMaxNodeBase::SetDup2Sided(bool b)
{
    GetMD;
    pMD->SetDup2Sided(b);
}
void            plMaxNodeBase::SetRadiateNorms(bool b)
{
    GetMD;
    pMD->SetRadiateNorms(b);
}
void            plMaxNodeBase::SetNormalChan(int n)
{
    GetMD;
    pMD->SetNormalChan(n);
}
void            plMaxNodeBase::SetIsGUI(bool b)
{
    GetMD;
    pMD->SetIsGUI(b);
}
void            plMaxNodeBase::SetSwappableGeom(plSharedMesh* sm)
{
    GetMD;
    pMD->SetSwappableGeom(sm);
}
void            plMaxNodeBase::SetSwappableGeomTarget(uint32_t id)
{
    GetMD;
    pMD->SetSwappableGeomTarget(id);
}
void            plMaxNodeBase::SetBoneMap(plMaxBoneMap* bones)
{
    GetMD;
    pMD->SetBoneMap(bones);
}
void            plMaxNodeBase::SetOverrideHighLevelSDL(bool b)
{
    GetMD;
    pMD->SetOverrideHighLevelSDL(b);
}
void            plMaxNodeBase::SetAnimCompress(uint8_t v)
{
    GetMD;
    pMD->SetAnimCompress(v);
}
void            plMaxNodeBase::SetKeyReduceThreshold(float v)
{
    GetMD;
    pMD->SetKeyReduceThreshold(v);
}
void            plMaxNodeBase::ClearRenderDependencies()
{
    GetMD;
    pMD->ClearRenderDependencies();
}

void            plMaxNodeBase::AddBone(plMaxNodeBase* m)
{
    GetMD;
