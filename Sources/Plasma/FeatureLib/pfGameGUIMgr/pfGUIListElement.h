...
public:
    ...
    virtual bool    CanBeDragged(void) {
        return false;
    }
    ...
    uint8_t   GetIndentLevel(void) const {
        return fIndentLevel;
    }
    void    SetIndentLevel(uint8_t i) {
        fIndentLevel = i;
    }
};
...
public:
    ...
    virtual const wchar_t*   GetText(void) {
        return fText;
    }
...
public:
    ...
    void    SetBorderSize(uint32_t size) {
        fBorderSize = (uint8_t)size;
    }
    void    SetRespectAlpha(bool r) {
        fRespectAlpha = r;
    }
...
public:
    ...
    uint32_t              GetNumChildren(void) const {
        return fChildren.GetCount();
    }
    pfGUIListElement*    GetChild(uint32_t i) const {
        return fChildren[ i ];
    }
    ...
    bool        IsShowingChildren(void) const {
        return fShowChildren;
    }
};
