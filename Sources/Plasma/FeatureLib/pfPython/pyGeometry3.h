...
public:
    ...
    PyObject* Copy() const {
        return pyPoint3::New(fPoint);
    }
    float Distance(const pyPoint3& other) const {
        return hsVector3(&fPoint, &other.fPoint).Magnitude();
    }
    float DistanceSquared(const pyPoint3& other) const {
        return hsVector3(&fPoint, &other.fPoint).MagnitudeSquared();
    }
};
...
public:
    ...
    // operator methods
    PyObject*   operator+(const pyVector3& b) const {
        return pyVector3::New(fVector + b.fVector);
    }
    PyObject*   operator-(const pyVector3& b) const {
        return pyVector3::New(fVector - b.fVector);
    }
    ...
    float Dot(const pyVector3& other) {
        return fVector * other.fVector;
    }
    PyObject* Cross(const pyVector3& other) const {
        return pyVector3::New(fVector % other.fVector);
    }
    float Magnitude() const {
        return fVector.Magnitude();
    }
    float MagnitudeSquared() const {
        return fVector.MagnitudeSquared();
    }
    void Zero() {
        fVector.fX = 0;
        fVector.fY = 0;
    ...
    PyObject* Scale(float scale) const {
        return pyVector3::New(fVector * scale);
    }
    PyObject* Add(const pyVector3& other) const {
        return pyVector3::New(fVector + other.fVector);
    }
    PyObject* Subtract(const pyVector3& other) const {
        return pyVector3::New(fVector - other.fVector);
    }
    PyObject* Copy() const {
        return pyVector3::New(fVector);
    }
};
