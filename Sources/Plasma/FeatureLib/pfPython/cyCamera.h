...
public:
    ...
    virtual void EnableFirstPersonOverride() const {
        SetEnableFirstPersonOverride(true);
    }
    virtual void DisableFirstPersonOverride() const {
        SetEnableFirstPersonOverride(false);
    }
