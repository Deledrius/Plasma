...
PyObject* pyLayer::GetTexture()
{
    ...
    if (fLayer)
        ...
        layer = plLayer::ConvertNoRef(fLayerKey->ObjectIsLoaded());
...
void pyLayer::SetOpacity(float opacity)
{
    plLayer* layer;
    if (fLayer)
        layer = fLayer;
...
PyObject* pyLayer::GetOpacity()
{
    ...
    return PyFloat_FromDouble(layer->GetOpacity());
}
#endif
