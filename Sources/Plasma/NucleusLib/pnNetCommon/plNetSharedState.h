...
public:
    ...
    plGenericVar* GetVar(int i) const {
        return fVars[i];
    }

    void RemoveVar(int i) {
        fVars.erase(fVars.begin() + i);
    }
    void AddVar(plGenericVar* v)    {
        fVars.push_back(v);
    }
    ...
    bool GetServerMayDelete() const {
        return fServerMayDelete;
    }
    void SetServerMayDelete(bool d) {
        fServerMayDelete = d;
    }
