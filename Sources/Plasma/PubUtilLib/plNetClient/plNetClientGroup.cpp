...
void plNetClientGroups::ISetGroupDesc(plNetGroupId& grpId)
{
    ...
    } else if (grpId.Room() == plNetGroup::kNetGroupLocalPlayer.Room()) {
        grpId.SetDesc("LocalPlayer");
    } else if (grpId.Room() == plNetGroup::kNetGroupRemotePlayer.Room()) {
        grpId.SetDesc("RemotePlayer");
    } else if (grpId.Room() == plNetGroup::kNetGroupLocalPhysicals.Room()) {
        grpId.SetDesc("LocalPhysicals");
    } else if (grpId.Room() == plNetGroup::kNetGroupRemotePhysicals.Room()) {
