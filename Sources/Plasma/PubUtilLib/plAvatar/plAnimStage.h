...
public:
    ...
    */
    ...
    void SetMod(plMultistageBehMod* p) {
        fMod = p;    // for returning ID#'s to python scripts:
    }
    plMultistageBehMod* GetMod() {
        return fMod;
    }
    bool GetIsAttached();
    ...
    plAGAnimInstance* GetAnimInstance() const {
        return fAnimInstance;
    };
    bool GetReverseOnIdle() {
        return fReverseOnIdle;
    }
    void SetReverseOnIdle(bool onOff) {
        fReverseOnIdle = onOff;
    }
