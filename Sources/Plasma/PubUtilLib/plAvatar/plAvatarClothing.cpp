...
bool plClothingMgr::IsLRMatch(plClothingItem* item1, plClothingItem* item2)
{
    ...
    if (item1->fTextures.GetCount() != item2->fTextures.GetCount()) {
        return false;
    }
