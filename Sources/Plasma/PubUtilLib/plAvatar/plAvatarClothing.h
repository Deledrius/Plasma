...
public:
    ...
    plClothingItemOptions() {
        fTint1.Set(1.f, 1.f, 1.f, 1.f);
        fTint2.Set(1.f, 1.f, 1.f, 1.f);
    }

    bool IsMatch(plClothingItemOptions* other) {
...
public:
    ...
    float GetAge() const {
        return fSkinBlends[0];
    }
    hsTArray<plClothingItem*>& GetItemList() {
        return fItems;
    }
    hsTArray<plClothingItemOptions*>& GetOptionList() {
        return fOptions;
    }
...
public:
    ...
    static plClothingMgr* GetClothingMgr() {
        return fInstance;
    }
    static void Init();
    static void DeInit();
