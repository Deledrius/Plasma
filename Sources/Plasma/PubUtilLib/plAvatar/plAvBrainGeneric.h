...
public:
    ...
    */
    ...
    bool GetReverseFBControlsOnRelease() const {
        return fReverseFBControlsOnRelease;
    };
    void SetReverseFBControlsOnRelease(bool val) {
        fReverseFBControlsOnRelease = val;
    };
    ...
    */
    plMessage* GetStartMessage() const {
        return fStartMessage;
    }
