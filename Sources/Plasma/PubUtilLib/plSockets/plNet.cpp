...
const char* plNet::GetErrorMsg(int error)
{
    ...
    case WSAEDISCON:
        return "Graceful disconnect in progress";
        break;
    ...
    case WSA_IO_INCOMPLETE:
        return "Overlapped I/O object not signalled";
        break;

    case WSA_IO_PENDING:
        return "Overlapped I/O will complete later";
        break;
    ...
    case WSA_INVALID_HANDLE:
        return "Event object handle not valid";
        break;
    };
