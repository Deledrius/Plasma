...
protected:
    ...
    bool IPeeked() const {
        return fPeekStatus == kFullyPeeked;
    }
    void ISetPeekStatus(uint32_t s) {
        fPeekStatus = s;
    }
...
public:
    ...
    bool NeedsReliableSend() const {
        return IsBitSet(kNeedsReliableSend);
    }
    bool IsSystemMessage() const {
        return IsBitSet(kIsSystemMessage);
    }
    virtual void ValidatePoke() const;
    virtual void ValidatePeek() const;
    virtual bool NeedsBroadcast() const {
        return false;    // should game server broadcast this message to other clients?
    }
    virtual int ValidationSchemeID() const {
        return 1;
    }

    // getters
    int GetPackSize();
    const plUnifiedTime& GetTimeSent() const {
        return fTimeSent;
    }
    bool GetHasTimeSent() const {
        return IsBitSet(kHasTimeSent);
    }
    double GetTimeReceived() const {
        return fTimeRecvd;
    }
    bool IsBitSet(int b) const {
        return (fFlags & b) != 0;
    }
    const plNetCommonMessage* GetNetCoreMsg() const {
        return fNetCoreMsg;
    }
    uint32_t GetNetCoreMsgLen() const;
    bool GetHasContext() const {
        return IsBitSet(kHasContext);
    }
    uint32_t GetContext() const {
        return fContext;
    }
    bool GetHasTransactionID() const {
        return IsBitSet(kHasTransactionID);
    }
    uint32_t GetTransactionID() const {
        return fTransactionID;
    }
    bool GetHasPlayerID() const {
        return IsBitSet(kHasPlayerID);
    }
    uint32_t GetPlayerID() const {
        hsAssert(GetHasPlayerID(), "uninit playerID");
        return fPlayerID;
    }
    uint32_t JustGetPlayerID() const {
        return fPlayerID;
    }
    bool GetHasAcctUUID() const {
        return IsBitSet(kHasAcctUUID);
    }
    const plUUID* GetAcctUUID() const {
        return &fAcctUUID;
    }
    uint8_t GetVersionMajor() const {
        return fProtocolVerMajor;
    }
    uint8_t GetVersionMinor() const {
        return fProtocolVerMinor;
    }
    ENetProtocol GetNetProtocol() const {
        return fNetProtocol;
    }

    // setters
    void SetTimeSent(const plUnifiedTime& t) {
        fTimeSent = t;
        SetHasTimeSent(true);
    }
    void SetHasTimeSent(bool value) {
        SetBit(kHasTimeSent, value);
    }
    void SetTimeReceived(double t) {
        fTimeRecvd = t;
    }
    void SetBit(int b, bool on = true) {
        if (on) {
            fFlags |= b;
        } else {
            fFlags &= ~b;
    ...
    void SetNetCoreMsg(const plNetCommonMessage* ncmsg) {
        fNetCoreMsg = ncmsg;
    }
    void SetHasContext(bool value) {
        SetBit(kHasContext, value);
    }
    void SetContext(uint32_t value) {
        fContext = value;
        SetHasContext(true);
    }
    void SetHasTransactionID(bool value) {
        SetBit(kHasTransactionID, value);
    }
    void SetTransactionID(uint32_t value) {
        fTransactionID = value;
        SetHasTransactionID(true);
    }
    void SetHasPlayerID(bool value) {
        SetBit(kHasPlayerID, value);
    }
    void SetPlayerID(uint32_t value) {
        fPlayerID = value;
        SetHasPlayerID(true);
    }
    void SetHasAcctUUID(bool v) {
        SetBit(kHasAcctUUID, v);
    }
    void SetAcctUUID(const plUUID* v) {
        fAcctUUID.CopyFrom(v);
        SetHasAcctUUID(true);
    }
    void SetVersion(uint8_t maj = kVerMajor, uint8_t min = kVerMinor) {
        SetBit(kHasVersion);
        fProtocolVerMajor = maj;
        fProtocolVerMinor = min;
    }
    void SetNetProtocol(ENetProtocol v) {
        fNetProtocol = v;
    }
...
public:
    plNetMsgServerToClient() {
        SetBit(kIsSystemMessage | kNeedsReliableSend);
    }
...
public:
    ...
    plNetMsgStreamHelper* StreamInfo() {
        return &fStreamHelper;
    }
    const plNetMsgStreamHelper* StreamInfo() const {
        return &fStreamHelper;
    }
};
...
public:
    ...
    plNetMsgObjectHelper* ObjectInfo() {
        return &fObjectHelper;
    }
    const plNetMsgObjectHelper* ObjectInfo() const {
        return &fObjectHelper;
    }
...
public:
    ...
    plNetMsgSDLState() : fIsInitialState(0), fPersistOnServer(true), fIsAvatarState(false) {
        SetBit(kNeedsReliableSend);
    }

    bool PersistOnServer() const {
        return fPersistOnServer != 0;
    }
    void SetPersistOnServer(bool b) {
        fPersistOnServer = b;
    }

    bool IsAvatarState() const {
        return fIsAvatarState != 0;
    }
    void SetIsAvatarState(bool b) {
        fIsAvatarState = b;
    }
    ...
    bool IsInitialState() const {
        return fIsInitialState != 0;
    }
    void SetIsInitialState(bool v) {
        fIsInitialState = v;
    }
...
public:
    ...
    plLocation GetRoomLoc(int i) const {
        return fRooms[i];
    }
    plString GetRoomName(int i) const {
        return fRoomNames[i];    // debug
    }
};
...
public:
    ...
    plClientUnifiedTime& GetDeliveryTime() {
        return fDeliveryTime;
    }
    void SetDeliveryTime(plClientUnifiedTime& ut) {
        fDeliveryTime = ut;
    }
...
public:
    ...
    void SetIsLoading(bool p)   {
        fIsLoading = p;
    }
    void SetIsInitialState(bool p) {
        fIsInitialState = p;
    }
...
public:
    ...
    plNetMsgPlayerPage() : fUnload(false) {
        SetBit(kNeedsReliableSend);
    }
...
public:
    ...
    plNetMsgReceiversListHelper* Receivers() {
        return &fReceivers;
    }
...
public:
    ...
    void SetPageFlags(uint8_t f) {
        fPageFlags = f;
    }
    uint8_t GetPageFlags() const {
        return fPageFlags;
    }

    void SetPagingOut(bool b) {
        if (b) {
            fPageFlags |= kPagingOut;
        } else {
            fPageFlags &= ~kPagingOut;
        }
    }
    bool GetPagingOut() const {
        return (fPageFlags & kPagingOut) != 0;
    }

    void SetResetList(bool b) {
        if (b) {
            fPageFlags |= kResetList;
        } else {
            fPageFlags &= ~kResetList;
        }
    }
    bool GetResetList() const {
        return (fPageFlags & kResetList) != 0;
    }

    void SetRequestingState(bool b) {
        if (b) {
            fPageFlags |= kRequestState;
        } else {
            fPageFlags &= ~kRequestState;
        }
    }
    bool GetRequestingState() const {
        return (fPageFlags & kRequestState) != 0;
    }
...
public:
    ...
    public:
        ...
        void Read(hsStream* s) {
            fGroupID.Read(s);
            s->LogReadLE(&fOwnIt, "GroupOwner OwnIt");
        }
...
public:
    ...
    GroupInfo GetGroupInfo(int i) const {
        return fGroups[i];
    }

    // setters
    void AddGroupInfo(GroupInfo gi) {
...
public:
    ...
    int GetVoiceDataLen() const {
        return fVoiceData.length();
    }
...
public:
    ...
    void SetSharedStateName(char* n) {
        if (n) {
            hsStrncpy(fSharedStateName, n, kMaxNameLen);
        }
    }
    char* GetSharedStateName() {
        return fSharedStateName;
    }
};
...
public:
    ...
    plNetMsgObjectListHelper* ObjectListInfo() {
        return &fObjectListHelper;
    }

    void SetMaxUpdateFreq(float f) {
        fMaxUpdateFreq = f;
    }
    float GetMaxUpdateFreq() const {
        return fMaxUpdateFreq;
    }
};
...
public:
    ...
    plNetMsgMemberListHelper* MemberListInfo() {
        return &fMemberListHelper;
    }
};
...
public:
    ...
    void SetAddingMember(bool b) {
        fAddMember = b;
    }

    plNetMsgMemberInfoHelper* MemberInfo() {
        return &fMemberInfo;
    }
    bool NeedsBroadcast() const {
        return true;    // send to all clients
    }
};
...
public:
    ...
    bool GetAdding() const {
        return fAdding;
    }
    void SetAdding(bool a) {
        fAdding = a;
    }

    // virtuals
    bool NeedsBroadcast() const {
        return true;    // use rcvrs list
    }
};
...
public:
    ...
    void SetNumInitialSDLStates(uint32_t n) {
        fNumInitialSDLStates = n;
    }
    uint32_t GetNumInitialSDLStates() const {
...
public:
    ...
    void SetRegionsICareAbout(const hsBitVector& r) {
        fRegionsICareAbout = r;
    }
    void SetRegionsImIn(const hsBitVector& r)       {
        fRegionsImIn = r;
    }

    const hsBitVector& GetRegionsICareAbout() const {
        return fRegionsICareAbout;
    }
    const hsBitVector& GetRegionsImIn() const       {
        return fRegionsImIn;
    }
