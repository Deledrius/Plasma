...
public:
    ...
    void    SetCustomizations(const plPlayerCustomizations* value) {
        fCustomizations = *value;
    }
    const plPlayerCustomizations* GetCustomizations() const {
        return &fCustomizations;
    }
    void    SetAvatarKey(plKey* key) {
        fAvatarKey = key;
    }
    const plKey* GetAvatarKey() const {
        return fAvatarKey;
    }
