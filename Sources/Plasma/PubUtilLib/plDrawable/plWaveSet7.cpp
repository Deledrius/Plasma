...
static inline float LenToFreq(float l)
{
    return 2.f * M_PI / l;
}

static inline float MPH2FPS(float f)
{
    return f * 5280.f / 3600.f;
}
static inline float FPS2MPH(float f)
{
    return f / 5280.f * 3600.f;
}
