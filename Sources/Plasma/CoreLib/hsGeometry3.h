...
public:
    ...
    hsScalarTriple*     Set(float x, float y, float z) {
        fX = x;
        fY = y;
        fZ = z;
        return this;
    }
    hsScalarTriple*     Set(const hsScalarTriple* p) {
        fX = p->fX;
        fY = p->fY;
        fZ = p->fZ;
        return this;
...
struct hsPoint3  : public hsScalarTriple {
    ...
    hsPoint3*    Set(float x, float y, float z) {
        return (hsPoint3*)this->hsScalarTriple::Set(x, y, z);
    }
    hsPoint3*    Set(const hsScalarTriple* p) {
        return (hsPoint3*)this->hsScalarTriple::Set(p) ;
    }
    ...
    hsPoint3& operator+=(const hsScalarTriple& s) {
        fX += s.fX;
        fY += s.fY;
        fZ += s.fZ;
        return *this;
    }
    hsPoint3& operator*=(const float s) {
        fX *= s;
        fY *= s;
        fZ *= s;
        return *this;
...
struct hsVector3 : public hsScalarTriple {
    ...
    hsVector3*   Set(float x, float y, float z) {
        return (hsVector3*)hsScalarTriple::Set(x, y, z);
    }
    hsVector3*   Set(const hsScalarTriple* p) {
        return (hsVector3*)hsScalarTriple::Set(p) ;
    }
    hsVector3*   Set(const hsScalarTriple* p1, const hsScalarTriple* p2) {
        return Set(p1->fX - p2->fX, p1->fY - p2->fY, p1->fZ - p2->fZ);
    }
...
//          return *this; };
    ...
    hsVector3& operator+=(const hsScalarTriple& s) {
        fX += s.fX;
        fY += s.fY;
        fZ += s.fZ;
        return *this;
    ...
    hsVector3& operator*=(const float s) {
        fX *= s;
        fY *= s;
        fZ *= s;
        return *this;
...
struct hsPoint4 {
    ...
    hsPoint4& operator=(const hsPoint3& p) {
        Set(p.fX, p.fY, p.fZ, 1.f);
        return *this;
    }
